...
const Login = () => {
    ...
    useEffect(() => {
        var config = {
            ...
            apiKey: '07394419-a5df-45c1-96b1-600bac6e3ca0',
    ...
    return <div className={classes.container}>
            <div className={classes.title}>
                <img src="https://see.fontimg.com/api/renderfont4/3z8d8/eyJyIjoiZnMiLCJoIjo4MSwidyI6MTI1MCwiZnMiOjY1LCJmZ2MiOiIjMDAwMDAwIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/U3RvcnkgQm9va3M/rooster-personal-use.png"></img>
